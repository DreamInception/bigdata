        ...
        methods: {
            ...
            requestAllData: function (url, seq) {
                if (seq == 1) {
                    ...
                    this.prosnum1 = this.studentdata1[back]["data"][0].length;
                    this.yearsnum1 = this.studentdata1[back]["time"].length;
                }
            ...
            renew: function () {
                ...
                delete this.zxchart;
                this.zxchart = echarts.init(document.getElementById('zx_map'));
            ...
            initZFT: function () {
                ...
                this.$nextTick(function () {
                    $("#selectbox_sort").selectBox().css({
                        "max-width": "130px",
                        "width": "130px"
                    });
                    new SelectBox($("#selectbox_sort")).refresh();
                    $("#selectbox_sort").on("change",this.rechange);
                    this.bjcharts = echarts.init(document.getElementById('bjmap12'));
                    ...
                    window.onresize = function () {
                        if (resizeTimer) clearTimeout(resizeTimer);
                        resizeTimer = setTimeout(function () {
                            that.bjcharts = echarts.init(document.getElementById('bjmap12'));
            ...
            initMap: function () {
                ...
                this.$nextTick(function () {
                    this.chinacharts = echarts.init(document.getElementById('chinamap12'));
                    ...
                    window.onresize = function () {
                        if (resizeTimer) clearTimeout(resizeTimer);
                        resizeTimer = setTimeout(function () {
                            that.chinacharts = echarts.init(document.getElementById('chinamap12'));
            ...
            sortbytpye: function (vlist, sorttype) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    xdata.push(vlist[i].Value.toFixed(1));
                ...
                for (var i = 0; i < this.yearsnum; i++) {            //年份大循环
                    ...
                    for (var h = 0; h < this.prosnum; h++) {
                        vlist.push({
                            ...
                            'Value': this.studentdata[back]["data"][i][h][type2] || 0
                        })
                    }     //vlist里是一个元素为字典的数组
                    ...
                    for (var j = 0; j < this.prosnum; j++) {
                        ...
                        gList.push([this.studentdata[back]["data"][i][j][type3],propotion[j],this.studentdata[back]["data"][i][j][type2]]);
                        ...
                        series: [
                            {
                                ...
                                data: this.getGDPdata(this.studentdata[back]["data"][i]),
            ...
            selectBoxForPro: function () {
                ...
                this.zxOptions = {
                    ...
                    xAxis: {
                        ...
                        data: this.studentdata1[back]['time'],
                    },
                    grid: {
                        left: '3%',
                        right: '6%',
            ...
            getseries: function () {
                ...
                for (var i = 0; i < this.prosnum1; i++) {
                    if (this.rates[i]['value'] == 1) {
                        nseries.push(this.studentdata1[back]['data'][0][i]['name']);
                        var pdata = [];
                        for (var j = 0; j < this.yearsnum1; j++) {
                            var tmp = this.studentdata1[back]['data'][j][i][cType];
                            tmp = tmp.toFixed(2);
                            if (this.studentdata1[back]['data'][j][i][cType] == 0) {
                                tmp = null;
                            };
                            pdata.push(tmp);
                        }
                        dseries.push({
                            name: this.studentdata1[back]['data'][0][i]['name'],    // 省份
                            type: 'line',
                            data: pdata,
                            symbol: 'circle',
                            // lineStyle: {
