        ...
        methods: {
            ...
            getZZToptions: function () {
                ...
                for (var i = 0; i < this.yearsnum; i++) {            //年份大循环
                    ...
                    //             gdplist1.push(this.studentdata[back3]["data"][i][h][type3])
                    //             gdplist2.push(this.studentdata[back2]["data"][i][h][type4])
                    ...
                    //     blist2[h]=gdplist4[h]/gdplist5[h]*100
                        if(this.ps == 1){
                            vlist.push({
                                ...
                                'Value': this.studentdata[back2]["data"][i][h][type2]
                            })
                        }else{
                            vlist.push({
                                'name': this.studentdata[back]["data"][i][h]["name"],
                        ...
                        series: [
                            {
                                ...
                                data: this.getGDPdata(this.studentdata[back2]["data"][i]),
