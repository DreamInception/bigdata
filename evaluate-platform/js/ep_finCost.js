        ...
        methods: {
            ...
            getZZToptions: function () {
                ...
                for (var i = 0; i < this.yearsnum; i++) {            //年份大循环
                    ...
                    for (var j=0;j<this.prosnum;j++){
                        for (var h=0;h<this.prosnum;h++){
                            if(this.studentdata[back]["data"][i][h]["name"]==pros[j]){
                                gdplist1.push(this.studentdata[back2]["data"][i][h][type2])
                                gdplist2.push(this.studentdata[back2]["data"][i][h][type3])
                                blist[j]=(gdplist1[j]/gdplist2[j]).toFixed(2)
                            }
                        }
                    ...
                    for (var h=0;h<this.prosnum;h++){
                        gdplist4.push(this.studentdata[back2]["data"][i][h][type2]);
                        gdplist5.push(this.studentdata[back2]["data"][i][h][type3]);
                        blist2[h]=(gdplist4[h]/(gdplist5[h])).toFixed(2);
                        vlist.push({
                    ...
                    for (var j = 0; j < this.prosnum; j++) {
                        ...
                        propotion[j]=this.studentdata[back2]["data"][i][j][type2]/(this.studentdata[back2]["data"][i][j][type3]);
                        gList.push([this.studentdata[back2]["data"][i][j][type3],this.studentdata[back2]["data"][i][j][type2],propotion[j]]);
